...
import { search, collectWait, init} from "@audio-commons/mediator-access";
...
class SearchSounds {
	...
	index(callback:Function = null){
		...
		search(searchQuery, function (results, response_id, collect_url) {
			...
			collectWait(response_id, collectOptions, function (result) {

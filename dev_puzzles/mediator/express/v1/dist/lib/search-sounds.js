...
var accessId = 0;
const mediator_access_1 = require("@audio-commons/mediator-access");
// TODO: here we need to wait for finish
// and support renewing token
mediator_access_1.init(function () {
...
class SearchSounds {
    ...
    index(callback = null) {
        ...
        mediator_access_1.search(searchQuery, function (results, response_id, collect_url) {
            ...
            let collectOptions = {};
            mediator_access_1.collectWait(response_id, collectOptions, function (result) {
